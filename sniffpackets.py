...
def analyze_udp_header(data_recv):
	...
	print "____________UDP HEADER____________"
        print "Source: %hu " % src_port
        print "Destination: %hu " % dst_port
        print "Lenght: %hu " % length
...
def analyze_tcp_header(data_recv):
	...
	print "____________TCP HEADER____________"
        print "Source: %hu " % src_port
        print "Destination: %hu " % dst_port
        print "Seq: %u " % seq_num
        print "Ack: %u " % ack_num
...
def analyze_ip_header(data_recv):
	...
	print "____________IP HEADER____________"
	print "Versiom: %hu " % ver
	print "IHL: %hu " % ihl
	print "TOS: %hu " % tos
	print "Lenght: %hu" % tot_len
	print "ID: %hu" % ip_id
	...
	print "Destination: %s" % dst_address
